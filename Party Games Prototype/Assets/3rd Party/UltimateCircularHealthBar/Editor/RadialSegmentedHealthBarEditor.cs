        ...
        public override void OnInspectorGUI() {
            ...
            if (generalFoldout) {
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    ...
                    SliderPropertyField("Arc", "The arcing of the progress bar. Tip: combine with 'Rotation', 'Radius' and 'Offset' to achieve a more linear progress bar", FindValueProperty(arc), 0, 1);
                    EditorGUILayout.PropertyField(radius, new GUIContent() { text = "Radius", tooltip = "The radius of the progress bar" });
                    SliderPropertyField("Line Width", "The thickness of the progress bar", FindValueProperty(lineWidth), 0, 1);
                    ...
                    SliderPropertyField("Rotation", "The rotation of the progress bar", FindValueProperty(rotation), 0, 360);
                ...
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    ...
                    if (FindValueProperty(pulsateWhenLow).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Percent Health Activation", "The percent value of the progress bar at which pulsating starts", FindValueProperty(pulseActivationThreshold), 0, 1);
                    ...
                    if (!innerTextureEnabled.hasMultipleDifferentValues && FindValueProperty(innerTextureEnabled).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Texture Opacity", "The opacity of the texture. 0 = only color, 1 = full texture visibilty", FindValueProperty(innerTextureOpacity), 0, 1);
                ...
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    ...
                    if (FindValueProperty(overlayTextureEnabled).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Texture Opacity", "The opacity of the texture. 0 = only color, 1 = full texture visibilty", FindValueProperty(overlayTextureOpacity), 0, 1);
            ...
            if (borderFoldout) {
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    SliderPropertyField("Border Width", "The width of the border. This affects the outside and inside border, not the space between segments. Refer to 'Border Spacing' for that.", FindValueProperty(borderWidth), 0, 1);
                    ...
                    if (FindValueProperty(borderTextureEnabled).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Texture Opacity", "The opacity of the texture. 0 = only color, 1 = full texture visibilty", FindValueProperty(borderTextureOpacity), 0, 1);
            ...
            if (depletedFoldout) {
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    SliderPropertyField("Depleted Transparency", "How visible should the portion of the progress bar be that has been depleted", FindValueProperty(removeBorder), 0, 1);
                    ...
                    if (FindValueProperty(emptyTextureEnabled).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Texture Opacity", "The opacity of the texture. 0 = only color, 1 = full texture visibilty", FindValueProperty(emptyTextureOpacity), 0, 1);
                ...
                using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                    ...
                    if (FindValueProperty(spaceTextureEnabled).boolValue) {
                        using (new EditorGUILayout.VerticalScope(EditorStyles.helpBox)) {
                            ...
                            SliderPropertyField("Texture Opacity", "The opacity of the texture. 0 = only color, 1 = full texture visibilty", FindValueProperty(spaceTextureOpacity), 0, 1);
